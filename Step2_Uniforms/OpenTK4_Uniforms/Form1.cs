...
namespace OpenTK4_Triangle
{
    public partial class Form1 : Form
    {
        ...
        int modelViewBufferHandle;
        int locationRotationMatrix;
        Matrix4[] mviewdata;
        ...
        private void Render()
        {
            ...
            mviewdata = new Matrix4[] { Matrix4.Rotate(new Vector3(0.0f, 0.0f, 1.0f), angle) };
            if (locationRotationMatrix >= 0)
                GL.UniformMatrix4(locationRotationMatrix, false, ref mviewdata[0]);
        ...
        private void CreateBuffers()
        {
            ...
            int[] uniformHandles = new int[1];

            //Создать буфер для Uniform переменной
            GL.GenBuffers(1, uniformHandles);

            modelViewBufferHandle = uniformHandles[0];
            locationRotationMatrix = GL.GetUniformLocation(ShaderProgramID, "RotationMatrix");
